...
#mon_init_node='xxx' (xxx对应你的第一个mon节点的主机名，只填一个)
mon_init_node='node1'
#mon_add_node=('aaa' 'bbb' 'ccc' ...) (aaa、bbb ... 对应你的额外的mon节点的主机名)
mon_add_node=('node2' 'node3')
#mon_node_ip="IP1,IP2,IP3,..." (IP1、IP2、...对应你所有mon节点的IP，用‘,’分割)
...
mon_num=${#mon_node[@]}
#osd信息初始化,根据实际情况修改
#osd_node=('osd1' 'osd2' 'osd3' ...) (osd1、osd2、...对应你所有osd节点的主机名)
